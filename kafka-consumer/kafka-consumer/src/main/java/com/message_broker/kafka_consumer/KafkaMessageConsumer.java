...
public class KafkaMessageConsumer {
    ...
    public void consumeCompany(ConsumerRecord<String, schema.avro.AvroCompany> record, Acknowledgment ack) {
        ...
        ack.acknowledge();
        log.debug("Offset {} committed for company {}", record.offset(), company.getCompanyId());
    }
    ...
    public void consumeMessageId(ConsumerRecord<String, String> record, Acknowledgment ack) {
        ack.acknowledge();
